// src/pages/admin/UsersList.tsx → VERSION ULTIME AVEC CALCUL D'ÂGE
...
interface AppUser {
  ...
  dateNaissance?: string;  // ← Ajouté depuis le backend
  active: boolean;
  avatar?: string;
}

// Fonction pour calculer l'âge à partir d'une date de naissance (format yyyy-MM-dd)
const calculateAge = (dateNaissance: string | undefined): string => {
  if (!dateNaissance) return 'Non renseigné';

  const birthDate = new Date(dateNaissance);
  if (isNaN(birthDate.getTime())) return 'Invalide';
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="grid grid-cols-2 gap-6 text-sm">
                <div className="space-y-3">
                  ...
                  <div><strong>Âge :</strong> {calculateAge(selectedUser.dateNaissance)}</div>
